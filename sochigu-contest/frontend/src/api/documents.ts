...
export const documentsApi = {
  ...
  create: (data: FormData) => apiClient.post('/documents/upload', data).then(r => r.data),
  update: (id: string, data: { title?: string; category?: string; isPublished?: boolean }) => apiClient.patch(`/documents/${id}`, data).then(r => r.data),
